...
if True:
    ...
    Зарплата_тестера=40000
    Зарплата_разработчика=84000
    Зарплата_внедренца=120000
    Зарплата_сисадмина=75000
    Количество_ЭВМ_=1
    Колиечство_разработчиков=1
    Количество_внедренцев=1
    Количество_тестеров=5
    Стоимость_комплекта_ЭВМ=80000
...
if True:
    ...
    Р_ком=0#проживание в гостинице
    Р_накл=З_ФОТВ*k_НР
...
if True:
    ...
    ЗП_1=Зарплата_тестера*Количество_тестеров*t_общ_1_мес*(1+k_У)
    ОТ_вн=ЗП_1*k_ОВФ
    #ЭВМ
    if True:
        #балансовая стоимость
        С_Б=Количество_тестеров*(Стоимость_комплекта_ЭВМ+Стоимость_комплекта_ЭВМ*k_ТУН)
        З_М=С_Б*k_М
        #сколько на заплаты
        З_ЗП=Зарплата_сисадмина*12*(1+k_У)
        #внебюджетные фонды?
...
if True:
    ...
    ЗП_2=Зарплата_тестера*Количество_тестеров*t_общ_2_мес*(1+k_У)
    ОТ_вн=ЗП_2*k_ОВФ
    #ЭВМ
    if True:
        #балансовая стоимость
