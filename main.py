...
if True:
    ...
    Стоимость_комплекта_ЭВМ_кассира=25000
    ...
    #сама операция
    N_опер_год=150
    МЗ_1=195#стоиость одной операции До
    МЗ_2=100#стоимость одной операции После
